...
def sharpe(returns, riskfree=0.0, tradingdays=252): #risk adjusted return where higher is better and it is annualized assuming daily returns
...
if __name__ == '__main__':
    ...
    benchmarkreturns=df.pct_change() #just buy and hold SPY as the comparison

...
S=st.sidebar.slider("Stock Price", 50, 200, 100) #sliders for adjusting all the inputs
...
p=price(S,K,T,r,sigma,optiontype=optiontype) #run price and all the greeks off whatever the sliders are set to

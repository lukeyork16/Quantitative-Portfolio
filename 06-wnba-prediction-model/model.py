...
if __name__ == '__main__':
    ...
    print("=== Walk-Forward Cross-Validation ===") #train only on seasons before the test season each time
    results=[]
    for testseason in [2023, 2024, 2025]:
        ...
        homebaseline=ytest.mean() #baseline: home team always wins
        eloonly, _, _, xtesteloonly, ytesteloonly = trainmodel(data, trainseasons, testseason, ["elodiff"]) #baseline: elo alone
    ...
    finalmodel, xtrain, ytrain, _, _ = trainmodel(data, seasons, testseason=9999, featurecols=fullfeatures) #train final model on everything for predicting future games
